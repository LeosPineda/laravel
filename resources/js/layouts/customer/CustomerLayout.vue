    ...
    <div class="md:hidden border-t border-gray-200 bg-white">
      <div class="px-4 sm:px-6">
        <nav class="flex justify-between py-3">
          ...
          <NotificationBell class="flex flex-col items-center py-2 px-3 hover:bg-gray-50 rounded-lg transition-colors" />
...
import NotificationBell from '@/components/customer/NotificationBell.vue'
