    ...
    <div class="min-h-screen bg-[#F5F5F5]">
            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="flex justify-between items-center h-16">
                    <div class="flex items-center gap-3">
                        ...
                        <span class="text-lg font-bold text-[#1A1A1A]">Food Court</span>
                    </div>
                    <button
                        @click="logout"
        ...
        <main class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            <div class="text-center py-16">
                ...
                <h1 class="text-2xl font-bold text-[#1A1A1A] mb-2">Welcome to Food Court!</h1>
                <p class="text-[#1A1A1A]/60 mb-6">Your account is ready. Browse vendors and start ordering.</p>
                <p class="text-sm text-[#1A1A1A]/40">Customer dashboard features coming soon...</p>
            </div>
        </main>
    </div>
</template>
